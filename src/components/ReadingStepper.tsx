...
export const READING_STEPPER_FIELDS: ReadingStepperField[] = [
  { key: "systolic", label: "Systolisk", unit: "mmHg", color: "text-red-600" },
  { key: "diastolic", label: "Diastolisk", unit: "mmHg", color: "text-orange-600" },
  { key: "pulse", label: "Puls", unit: "bpm", color: "text-blue-600" },
];
