...
const da: Record<string, string> = {
  ...
  "bp.classificationCaveat": "DCS-tabel 27.1 gælder daggennemsnit fra hjemme- eller døgnblodtryksmåling, eller uobserveret automatisk klinikmåling, hvis de andre metoder ikke er mulige. Appen anvender tabellen på enkelte gemte målinger og periodesnit alene som visning. Denne tilpasning er ikke klinisk gennemgået eller valideret og er hverken en diagnose eller et behandlingsmål. DCS bemærker, at systolisk blodtryk under 120 mmHg kan være for lavt hos ældre; appen vurderer ikke dette.",
  "bp.classificationShortNote": "Ikke klinisk valideret app-kategori; ikke diagnose eller behandlingsmål.",
...
const en: Record<string, string> = {
  ...
  "bp.classificationCaveat": "DCS table 27.1 is defined for daytime averages from home or ambulatory blood-pressure monitoring, or unattended automated clinic measurements if those methods are not possible. This app applies the table to individual saved readings and report-period means for display only. This adaptation has not been clinically reviewed or validated and is neither a diagnosis nor a treatment target. DCS notes that systolic blood pressure below 120 mmHg may be too low for older adults; the app does not assess this.",
  "bp.classificationShortNote": "Unvalidated app category; not a diagnosis or treatment target.",
  ...
  "pdf.classificationScope": "DCS table 27.1 applies to daytime averages from home or ambulatory monitoring, or unattended automated clinic measurement if other methods are not possible. The app applies these categories to individual saved readings and report-period means for display only. This adaptation has not been clinically reviewed or validated and is neither a diagnosis nor a treatment target. DCS notes that systolic blood pressure below 120 mmHg may be too low for older adults; the app does not assess this.",
