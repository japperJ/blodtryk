...
const da: Record<string, string> = {
  ...
  // Kategorierne bruger grænserne i DCS NBV tabel 27.1.
  "bp.normal.label": "Normal",
  "bp.normal.desc": "Begge værdier ligger i tabellens normalinterval (systolisk 100–129 og diastolisk 60–79 mmHg).",
  "bp.elevated.label": "Let forhøjet",
  "bp.elevated.desc": "Mindst én værdi ligger i intervallet let forhøjet i DCS-tabel 27.1.",
  "bp.grade1.label": "Grad 1",
  "bp.grade1.desc": "Mindst én værdi ligger i intervallet grad 1 i DCS-tabel 27.1.",
  "bp.grade2.label": "Grad 2",
  "bp.grade2.desc": "Mindst én værdi ligger i intervallet grad 2 i DCS-tabel 27.1.",
  "bp.grade3.label": "Grad 3",
  "bp.grade3.desc": "Mindst én værdi når grænsen for grad 3 i DCS-tabel 27.1.",
  "bp.unclassified.label": "Ikke klassificeret",
  "bp.unclassified.desc": "Værdierne passer ikke i en kategori i tabel 27.1; appen tildeler ikke en kategori for lavt blodtryk.",
  "bp.unclassified.ageDesc": "DCS' voksenkategorier vises kun, når den tilgængelige alder er mindst 19 år. Ved manglende alder eller alder på 18 år eller derunder vises ingen kategori. Appen indeholder ingen pædiatriske tærskler eller råd.",
  "bp.classificationCaveat": "DCS-tabel 27.1 gælder daggennemsnit fra hjemme- eller døgnblodtryksmåling, eller uobserveret automatisk klinikmåling, hvis de andre metoder ikke er mulige. Appen anvender tabellen på enkelte gemte målinger og periodesnit alene som visning. DCS-voksenkategorier vises kun, når den tilgængelige alder er mindst 19 år; manglende alder eller alder på 18 år eller derunder forbliver ikke klassificeret. Grænsen på 19 år er en konservativ app-regel, ikke en DCS-tærskel; appen indeholder ingen pædiatriske tærskler eller råd. Aldersbegrænsningen påvirker kun kategorivisningen; alle målinger bevares i historik og numeriske periodesnit. Tilpasningen er ikke klinisk gennemgået eller valideret og er hverken en diagnose eller et behandlingsmål. DCS bemærker, at systolisk blodtryk under 120 mmHg kan være for lavt hos ældre; appen vurderer ikke dette.",
  "bp.classificationShortNote": "DCS-voksenkategorier vises kun ved alder på mindst 19 år; manglende alder eller alder på 18 år eller derunder forbliver ikke klassificeret. Ingen pædiatriske tærskler eller råd. Ikke klinisk valideret; ikke en diagnose eller et behandlingsmål.",
  "bp.classificationSource": "Officiel kilde til retningslinjen",
  "bp.classificationVersion": "App-regelversion: {version} (kontrolleret {date})",
  ...
  "trends.distributionTotal": "{count} målinger i denne fordeling",
  ...
  "pdf.distribution": "Kategorier for enkelte målinger:",
  "pdf.periodMeanCategory": "Kategori ud fra gennemsnittet af valgte målinger (kun app-visning): {label}",
  "pdf.classificationHeading": "Regelgrundlag og begrænsninger",
  "pdf.classificationSource": "Regelgrundlag: {guideline}, tabel {table} (revision {revision})",
  "pdf.classificationVersion": "App-regelversion: {version} (kontrolleret {date})",
  "pdf.classificationUrl": "Officiel kilde: {url}",
  "pdf.classificationScope": "DCS-tabel 27.1 gælder gennemsnit i dagtimerne ved hjemme- eller døgnmåling, alternativt uobserveret automatisk klinikmåling hvis andet ikke er muligt. Appen anvender kategorierne på enkelte gemte målinger og periodesnit alene som visning. Kategorier vises kun ved tilgængelig alder på mindst 19 år; manglende alder eller alder på 18 år eller derunder forbliver ikke klassificeret. Et periodesnit klassificeres kun, hvis alle inkluderede målinger opfylder alderskravet; alle målinger indgår fortsat i de numeriske periodesnit og historikken. Grænsen på 19 år er en konservativ app-regel, ikke en DCS-tærskel; appen indeholder ingen pædiatriske tærskler eller råd. Tilpasningen er ikke klinisk gennemgået eller valideret og er hverken en diagnose eller et behandlingsmål. DCS bemærker, at systolisk blodtryk under 120 mmHg kan være for lavt hos ældre; appen vurderer ikke dette.",
  "pdf.classificationPrecision": "Ved periodesnit sammenlignes det uafrundede gennemsnit med grænserne; kun det viste gennemsnit afrundes.",

  "pdf.ageLine": "Alder: {age} år",
  ...
  "pdf.periodTitle": "Vælg periode",
  "pdf.periodHint": "Rapporten viser kun målinger inden for perioden.",
  ...
  "pdf.exportPdfAction": "Eksportér PDF",
...
const en: Record<string, string> = {
  ...
  // Categories use the thresholds in DCS NBV table 27.1.
  "bp.normal.label": "Normal",
  "bp.normal.desc": "Both values fall in the table's normal interval (systolic 100–129 and diastolic 60–79 mmHg).",
  "bp.elevated.label": "Slightly elevated",
  "bp.elevated.desc": "At least one value falls in the slightly elevated interval in DCS table 27.1.",
  "bp.grade1.label": "Grade 1",
  "bp.grade1.desc": "At least one value falls in the grade 1 interval in DCS table 27.1.",
  "bp.grade2.label": "Grade 2",
  "bp.grade2.desc": "At least one value falls in the grade 2 interval in DCS table 27.1.",
  "bp.grade3.label": "Grade 3",
  "bp.grade3.desc": "At least one value reaches the grade 3 threshold in DCS table 27.1.",
  "bp.unclassified.label": "Unclassified",
  "bp.unclassified.desc": "The values do not meet a category in table 27.1; this app does not assign a low-blood-pressure category.",
  "bp.unclassified.ageDesc": "DCS adult categories are shown only when the age available to classification is 19 or older. If age is missing or 18 or younger, no category is shown. This app provides no pediatric thresholds or advice.",
  "bp.classificationCaveat": "DCS table 27.1 is defined for daytime averages from home or ambulatory blood-pressure monitoring, or unattended automated clinic measurements if those methods are not possible. This app applies the table to individual saved readings and report-period means for display only. DCS adult categories are shown only when the age available to classification is 19 or older; missing age or age 18 and younger remains unclassified. The 19+ cutoff is a conservative app eligibility rule, not a DCS threshold; this app provides no pediatric thresholds or advice. The age restriction affects category display only; all readings remain in history and numeric period means. This adaptation has not been clinically reviewed or validated and is neither a diagnosis nor a treatment target. DCS notes that systolic blood pressure below 120 mmHg may be too low for older adults; the app does not assess this.",
  "bp.classificationShortNote": "DCS adult categories only when available age is 19+; missing age or age 18 and younger stays unclassified. No pediatric thresholds or advice. Not clinically validated; not a diagnosis or treatment target.",
  "bp.classificationSource": "Official guideline source",
  "bp.classificationVersion": "App rule version: {version} (verified {date})",
  ...
  "trends.distributionTotal": "{count} readings in this distribution",
  ...
  "pdf.distribution": "Categories for individual readings:",
  "pdf.periodMeanCategory": "Category from the arithmetic mean of selected readings (app display only): {label}",
  "pdf.classificationHeading": "Rule basis and limitations",
  "pdf.classificationSource": "Rule basis: {guideline}, table {table} (revision {revision})",
  "pdf.classificationVersion": "App rule version: {version} (verified {date})",
  "pdf.classificationUrl": "Official source: {url}",
  "pdf.classificationScope": "DCS table 27.1 applies to daytime averages from home or ambulatory monitoring, or unattended automated clinic measurement if other methods are not possible. The app applies these categories to individual saved readings and report-period means for display only. Categories are shown only when available age is 19 or older; missing age or age 18 and younger remains unclassified. A report-period mean is classified only when every included reading meets the age rule; all readings still contribute to numeric means and history. The 19+ cutoff is a conservative app eligibility rule, not a DCS threshold; this app provides no pediatric thresholds or advice. This adaptation has not been clinically reviewed or validated and is neither a diagnosis nor a treatment target. DCS notes that systolic blood pressure below 120 mmHg may be too low for older adults; the app does not assess this.",
  "pdf.classificationPrecision": "For a report-period mean, the unrounded mean is compared with the thresholds; only the displayed mean is rounded.",

  "pdf.ageLine": "Age: {age} years",
  ...
  "pdf.periodTitle": "Choose period",
  "pdf.periodHint": "The report only includes measurements within the period.",
  ...
  "pdf.exportPdfAction": "Export PDF",
