...
- Appens DCS-voksenkategorier vises kun, når den tilgængelige alder er mindst 19 år. Manglende alder eller alder på 18 år eller derunder forbliver ikke klassificeret. Grænsen på 19 år er en konservativ app-regel, ikke en DCS-tærskel; appen indeholder ingen pædiatriske tærskler eller råd. Alle målinger indgår fortsat i numeriske gennemsnit og historik; periodesnit klassificeres kun, når alle inkluderede målinger opfylder alderskravet.
- Batchtidslinjen bruger bevidst `derivedAge` fra den aktuelt valgte profil; historik, statistik og PDF-eksport bruger hver gemt målings alder. Denne valgte forskel ændrer ikke batch-API'en.
- Appen fastsætter ikke patient-specifikke behandlingsmål. DCS’ tabel 27.2 om behandlingsmål er særskilt og implementeres ikke. DCS bemærker i tabel 27.1, at systolisk blodtryk under 120 mmHg kan være for lavt hos ældre; appen vurderer ikke denne bemærkning.
